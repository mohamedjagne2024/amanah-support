...
export default function Edit({
  ...
  const { data, setData, processing, errors } = useForm({
    ...
    sub_category_id: asset.subcategory ? String(asset.subcategory.id) : '',
    serial_number: asset.serial_number || '',
    location_id: asset.location ? String(asset.location.id) : '',
    staff_id: asset.staff ? String(asset.staff.id) : '',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    router.post(`/asset-management/${asset.id}`, {
      _method: 'PUT',
      ...data,
    }, {
      forceFormData: true,
  ...
  return (
    <AppLayout>
      ...
      <main className="max-w-4xl">
        <PageBreadcrumb title="Edit Asset" subtitle="Asset Management" />
                ...
                {asset.image && !imagePreview && (
                  <div>
                    ...
                    <img
                      src={asset.image}
                      alt="Current asset"
                      className="max-w-32 rounded-lg border border-default-200"
                    />
                  </div>
                )}
              </div>
