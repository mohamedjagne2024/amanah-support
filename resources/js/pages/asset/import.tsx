...
const SYSTEM_FIELDS: Array<{ value: string; label: string; required: boolean }> = [
  ...
  { value: "assigned_staff", label: "Assigned Staff", required: false },
...
export default function Import() {
  ...
  const handleUploadFile = useCallback(() => {
    ...
    setIsUploading(true);
    router.post("/asset-management/import/upload", formData, {
      onSuccess: () => {
        setCurrentStep(1);
      },
      onError: (errors) => {
  ...
  const handleGeneratePreview = useCallback(() => {
    ...
    router.post(
      "/asset-management/import/preview",
  ...
  const handleConfirmImport = useCallback(() => {
    setIsProcessing(true);
    router.post(
      "/asset-management/import/execute",
      { mappings: fieldMappings },
      {
        onSuccess: () => {
          router.visit("/asset-management");
        },
        onFinish: () => {
          setIsProcessing(false);
        }
              ...
              <div className="card-body space-y-5">
                ...
                <div className="rounded-lg bg-default-50 border border-default-200 p-4 mt-3">
                  ...
                  <ul className="text-sm text-default-600 space-y-1">
                    ...
                    <li>• Categories, locations, and staff must match existing records</li>
                  </ul>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border border-default-200 rounded-lg mt-3">
                  ...
                  <a href="/templates/assets-import-template.xlsx" download>
              ...
              <div className="card-footer">
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      Import {props.previewData.valid_count} Asset{props.previewData.valid_count !== 1 ? 's' : ''}
                    </>
                  )}
                </button>
              </div>
