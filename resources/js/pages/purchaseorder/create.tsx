...
export default function Create({ staffList, locations, departments, subcategories }: CreatePurchaseOrderPageProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Post with calculated values included
  ...
  return (
    <AppLayout>
      <PageMeta title="Create Purchase Order" />
      <main className="max-w-5xl">
        <PageBreadcrumb title="Create Purchase Order" subtitle="Asset Management" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="form-input bg-default-100"
                    />
                    <p className="mt-1 text-xs text-default-600">Auto-generated based on settings</p>
                  </div>
                </div>
