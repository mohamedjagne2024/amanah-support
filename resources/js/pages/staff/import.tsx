...
export default function Import() {
  ...
  const handleUploadFile = useCallback(() => {
    ...
    setIsUploading(true);
    router.post("/staffs/import/upload", formData, {
      onSuccess: () => {
        setCurrentStep(1);
      },
      onError: (errors) => {
              ...
              <div className="card-body space-y-5">
                ...
                <div className="rounded-lg bg-default-50 border border-default-200 p-4 mt-3">
                  ...
                  <ul className="text-sm text-default-600 space-y-1">
                    ...
                    <li>• Department names must match existing records exactly</li>
                ...
                <div className="flex items-center justify-between p-4 border border-default-200 rounded-lg mt-3">
                  ...
                  <a href="/templates/staff-import-template.xlsx" download>
                  ...
                  <table className="min-w-full divide-y divide-default-200 dark:divide-white/14">
                    <thead className="bg-default-150">
                      <tr className="text-default-600">
                        ...
                        <th className="py-3 px-3.5 text-start text-sm font-medium">Email</th>
                      ...
                      {props.previewData.preview_records.slice(0, 10).map((record, index) => (
                        <tr key={index} className="text-default-800">
                          ...
                          <td className="py-2.5 px-3.5 text-sm text-default-600">
                            {record.data.email || <span className="text-default-400 italic">-</span>}
                          </td>
                          <td className="py-2.5 px-3.5">
              ...
              <div className="card-footer">
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      Import {props.previewData.valid_count} Staff Member{props.previewData.valid_count !== 1 ? 's' : ''}
                    </>
                  )}
                </button>
              </div>
