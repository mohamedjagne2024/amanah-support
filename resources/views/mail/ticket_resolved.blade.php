...
<head>
    ...
    <title>Ticket Closed - Amanah Support</title>
    <style>
        .mail-body img {
            border: none;
...
<body>
    <span class="preheader">Your ticket will auto-close soon - respond if you need help</span>
                            ...
                            <td class="wrapper">
                                ...
                                <table role="presentation" class="main-table" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <p>Hi {name},</p>
                                            <p>We're writing to inform you that your support ticket has been marked as resolved. We believe your issue has been addressed successfully.</p>
                                            <p><strong>Important:</strong> This ticket will be automatically closed permanently in <strong>{autoclose_value} {autoclose_unit}</strong> unless you respond or reopen it.</p>
                                            ...
                                            <p>If you feel that your issue has not been fully resolved or if you have any additional questions, please respond to this ticket within the next <strong>{autoclose_value} {autoclose_unit}</strong>. You can view the ticket details and respond by clicking the link above.</p>
                                            <p>After this period, the ticket will be permanently closed. You can always create a new ticket if you need further assistance.</p>
                                            <p>We appreciate your patience and thank you for using Amanah Support!</p>
                                            <p>Thank you!</p>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block">
                                    <span class="apple-link">Amanah Support - Your trusted support system</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="content-block powered-by">
                                    © 2026 Amanah Insurance - All rights reserved.
                                </td>
                            </tr>
                        </table>
                    </div>
